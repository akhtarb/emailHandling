<?php  
session_start();
/* Message class has the basic information of Emails and all the other classes inheritance this class*/
 class Message  
{  
...
/* draft class get the basic data of Message class and add some attribute to it such as date of
edditting the file and list of people to suppose to send email to them*/
...
/* This class is just for sending part of the project*/	
...
Query the data and make json to send data to another file*/
...
/* The main method of this project is defined here and method is get called in this module*/
$obj = new Draft;  
$to = array();
